package com.api.apiRegion.security;

import com.api.apiRegion.security.jwt.AuthEntryPointJwt;
import com.api.apiRegion.security.jwt.AuthTokenFilter;
import com.api.apiRegion.security.services.CollaborateurDetailsServiceImpl;
  ...
  */
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    http.cors().and().csrf().disable()
        ...
        .antMatchers("/api/annee/**").permitAll()
        .antMatchers("/api/pays/**").permitAll()
        .antMatchers("/api/habitant/**").permitAll()
